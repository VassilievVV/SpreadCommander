...
{
	public sealed class StringLogicalComparer : IComparer, IComparer<string>
	{
		...
		public static IComparer<string> DefaultComparer
		{
			get {return _default;}
		}
		...
		public static int Compare(string s1, string s2, bool caseSensitive)
		{

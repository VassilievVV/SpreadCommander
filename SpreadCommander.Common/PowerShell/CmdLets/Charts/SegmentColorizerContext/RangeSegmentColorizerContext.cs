...
{
	public class RangeSegmentColorizerContext: BaseSegmentColorizerContext
	{
		...
		{
			return new RangeSegmentColorizer();
		}

		public override void SetupXtraChartColorizer(ChartContext chartContext, SegmentColorizerBase colorizer)
		{
			var rangeColorizer = colorizer as RangeSegmentColorizer ?? throw new Exception("Colorizer must be Range segment colorizer.");

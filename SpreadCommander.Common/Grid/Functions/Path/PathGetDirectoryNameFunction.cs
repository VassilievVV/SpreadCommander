...
{
    public class PathGetDirectoryNameFunction : ICustomFunctionOperatorBrowsable
    {
        public const string FunctionName = "PathGetDirectoryName";
        static readonly PathGetDirectoryNameFunction instance = new PathGetDirectoryNameFunction();
        ...
        public object Evaluate(params object[] operands)
        {
            ...
            try
            {
                ...
                var result = IO.Path.GetDirectoryName(path);
                return result;
            }
            catch (Exception)
            {

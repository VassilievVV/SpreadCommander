...
{
    public class Base64DecodeFunction : ICustomFunctionOperatorBrowsable
    {
        public const string FunctionName              = "Base64Decode";
        static readonly Base64DecodeFunction instance = new();
        ...
        public string Description                                                     => "Decodes Base64-encoded text.";

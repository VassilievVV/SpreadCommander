...
{
    public class Spline3DSeriesOptions: Line3DSeriesOptions
    {
        [Description("Line tension (\"smoothness\" of a spline curve) to be used when drawing splines of the Spline3DSeriesView, in percents.")]

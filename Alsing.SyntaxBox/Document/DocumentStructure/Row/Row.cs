...
namespace Alsing.Windows.Forms.Document.DocumentStructure.Row
{
    ...
    public sealed class Row : IEnumerable
    {
        ...
        /// 
        /// </summary>
        public Span.Span expansion_EndSpan;
        ...
        /// 
        /// </summary>
        public Span.Span expansion_StartSpan;
        ...
        /// </summary>
        public Word.Word this[int index]
        {
            get
            {
                if (index >= 0)
        ...
        public int StartWordIndex
        {
            get
            {
                ...
                Word.Word w = expansion_StartSpan.StartWord;

                int i = 0;
                foreach (Word.Word wo in this)
                {
                    if (wo == w)
                        break;
                    i += wo.Text.Length;
        ...
        public Word.Word FirstNonWsWord
        {
            get
            {
                foreach (Word.Word w in this)
                {
        ...
        {
            var xw = new Word.Word {Row = this, Text = text};
            words.Add(xw);
            return xw;
        }
        ...
        /// <returns></returns>
        public Word.Word FindRightWordByPatternList(PatternList PatternList, Word.Word StartWord, bool IgnoreStartWord)
        {
        ...
        /// <param name="IgnoreStartWord"></param>
        /// <returns></returns>
        public Word.Word FindLeftWordByPatternListName(string PatternListName, Word.Word StartWord, bool IgnoreStartWord)
        {
            int i = StartWord.Index;
            if (IgnoreStartWord)
                i--;
        ...
        /// <param name="IgnoreStartWord"></param>
        /// <returns></returns>
        public Word.Word FindRightWordByBlockType(SpanDefinition spanDefinition, Word.Word StartWord, bool IgnoreStartWord)
        {
            int i = StartWord.Index;
            if (IgnoreStartWord)
                i++;
        ...
        /// <param name="IgnoreStartWord"></param>
        /// <returns></returns>
        public Word.Word FindLeftWordByBlockTypeName(string BlockTypeName, Word.Word StartWord, bool IgnoreStartWord)
        {
            int i = StartWord.Index;
            if (IgnoreStartWord)
                i--;

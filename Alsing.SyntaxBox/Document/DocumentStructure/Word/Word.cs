...
namespace Alsing.Windows.Forms.Document.DocumentStructure.Word
{
    /// <summary>
    /// Word types
    /// </summary>
    ...
    public sealed class Word
    {
        ...
        //VVV - allow to customize
        public static Color DefaultErrorColor = Color.Red;

        /// <summary>
        /// Color of the error wave lines
        /// </summary>
        public Color ErrorColor = //Color.Red;	//VVV
            DefaultErrorColor;
        ...
        /// The parent row
        /// </summary>
        public Row.Row Row; //the row that holds this word

        /// <summary>
        /// The parent span
        /// </summary>
        public Span.Span Span; //the span that this word is located in

...
namespace Alsing.Windows.Forms.Document.SyntaxDefinition.Scope
{
    ...
    public sealed class Scope
    {
        ...
        /// </summary>
        public SpanDefinition.SpanDefinition Parent;

        /// <summary>
        /// spanDefinition that should be started directly after this block have ended
        /// </summary>
        public SpanDefinition.SpanDefinition spawnSpanOnEnd;

        /// <summary>
        /// spanDefinition that should be started directly after this block have started
        /// </summary>
        public SpanDefinition.SpanDefinition spawnSpanOnStart;

        /// <summary>
        /// The Start trigger Pattern
        /// </summary>
        public Pattern.Pattern Start;

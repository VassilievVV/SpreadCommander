...
namespace Alsing.Windows.Forms.Document.SyntaxDefinition.Pattern
{
    /// <summary>
    ...
    public sealed class PatternList : IEnumerable
    {
        ...
        /// <summary>
        /// Gets or Sets if this list contains case sensitive patterns
        /// </summary>		
        ...
        /// </summary>
        public SpanDefinition.SpanDefinition parentSpanDefinition;
        ...
        /// </summary>
        public TextStyle.TextStyle Style = new TextStyle.TextStyle();
        ...
        public PatternList()
        {
			...
			SimplePatterns = new Hashtable(StringComparer.InvariantCultureIgnoreCase);
		}
        ...
        public Pattern Add(Pattern Pattern)
        {
            ...
            {
                //store pattern in lookup table if it is a simple pattern
                string s;

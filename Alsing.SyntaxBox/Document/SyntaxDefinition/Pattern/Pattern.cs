...
namespace Alsing.Windows.Forms.Document.SyntaxDefinition.Pattern
{
    ...
    public sealed partial class Pattern
    {
        ...
        public BracketType BracketType = Windows.Forms.Document.DocumentStructure.Structs.BracketType.None;
        ...
        public Pattern(string pattern, bool iscomplex)
        {
            ...
            {
                IsComplex = true;
				rx = new Regex(StringPattern, /*RegexOptions.Compiled*/ RegexOptions.None);	//VVV - remove RegexOptions.Compiled
            }
            else
            {
                IsComplex = false;

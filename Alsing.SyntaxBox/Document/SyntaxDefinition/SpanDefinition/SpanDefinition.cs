...
namespace Alsing.Windows.Forms.Document.SyntaxDefinition.SpanDefinition
{
    /// <summary>
    ...
    {
        private readonly List<Pattern.Pattern> tmpSimplePatterns = new List<Pattern.Pattern>();
    ...
    public class PatternComparer : IComparer<Pattern.Pattern>
    {
        public int Compare(Pattern.Pattern x, Pattern.Pattern y)
        {

...
using Alsing.Windows.Forms.Document.Parser;
...
namespace Alsing.Windows.Forms.Document
{
    /// <summary>
    ...
    public class SyntaxDocument : Component, IEnumerable
    {
        ...
        private void Init()
        {
            var l = new SyntaxDefinition.SyntaxDefinition();
...
//			}
        ...
        public void SetSyntaxFromEmbeddedResource(Assembly assembly, String resourceName)
        {
            ...
            if (stream != null)
            {
                ...
                Parser.Init(SyntaxDefinition.SyntaxDefinition.FromSyntaxXml(xml));
                Text = Text;
            }
        }

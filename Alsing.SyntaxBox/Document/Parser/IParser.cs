...
namespace Alsing.Windows.Forms.Document.Parser
{
    ...
    public interface IParser
    {
        ...
        /// </summary>
        SyntaxDefinition.SyntaxDefinition SyntaxDefinition { get; set; }

        string Separators { get; set; }

        /// <summary>
        /// Initializes the parser with a specified SyntaxFile
        /// </summary>
        ...
        /// <summary>
        /// Initializes the parser with a specified syntaxDefinition object
        /// </summary>
        /// <param name="syntaxDefinition">The Language object to assign to the parser</param>
        void Init(SyntaxDefinition.SyntaxDefinition syntaxDefinition);

...
namespace Alsing.Windows.Forms.Design
{
	/// <summary>
	...
	public class CollectionEditorGui : UserControl
	{
		...
		private void IstMembers_DrawItem(object sender, DrawItemEventArgs e)
		{
			try
			{
				if (e.Index == -1)
                ...
                //VVV - move to .Net Core
                bool SupportPaint = false; //Editor.GetPaintValueSupported();
		...
		private void IstMembers_SelectedIndexChanged(object sender, EventArgs e)
		{
			EnableRemove();
			SelectObject();
		}
        ...
        */
		...
		private void InitializeComponent()
		{
			...
			this.lstMembers.DrawItem += new System.Windows.Forms.DrawItemEventHandler(this.IstMembers_DrawItem);
			this.lstMembers.SelectedIndexChanged += new System.EventHandler(this.IstMembers_SelectedIndexChanged);
			// 
			// btnUp
			// 

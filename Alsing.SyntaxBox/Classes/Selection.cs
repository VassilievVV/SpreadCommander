...
#pragma warning restore CRR0026 // Unused member
        ...
        public void Outdent()
        {
                 ...
                 i++)
            {
                ...
                var b = new UndoBlock() { Action = UndoAction.DeleteRange };
                b.Position.X = 0;
                b.Position.Y = i;
                ActionGroup.Add(b);
                string s = xtr.Text;
        ...
        //VVV - keyboard actions
        internal void Indent(object sender, KeyboardActionEventArgs args)
        {
            //VVV
            //Indent();
            string indentText = "\t";
            if (sender is EditViewControl viewControl && viewControl.TabsToSpaces)
                indentText = new string(' ', viewControl.TabSize);
            Indent(indentText);
        }

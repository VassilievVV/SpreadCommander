...
namespace Alsing.Windows.Forms.Controls.SyntaxBox.Dialogs
{
    /// <summary>
    ...
    public class FindReplaceForm : Form
    {
        ...
        private EditViewControl _Owner
        {
            get
            {
                if (_Control != null)
        ...
        {
            _Owner.ReplaceSelection(cboReplace.Text);
        ...
        private void BtnReplaceAll_Click(object sender, EventArgs e)
        {
            ...
            int x = _Owner.Caret.Position.X;
            int y = _Owner.Caret.Position.Y;
            _Owner.Caret.Position.X = 0;
            _Owner.Caret.Position.Y = 0;
            while (_Owner.SelectNext(cboFind.Text, chkMatchCase.Checked,
        ...
        public void FindNext()
        {
            ...
            _Owner.SelectNext(cboFind.Text, chkMatchCase.Checked,
                              chkWholeWord.Checked, chkRegEx.Checked);
        }

...
using Alsing.Windows.Forms.Drawing.GDI32;
using System;
...
namespace Alsing.Windows.Forms.Controls.SyntaxBox
{
    /// <summary>
    ...
    public class SyntaxBoxControl : SplitViewParentControl
    {
        ...
        /// <br/>
        /// &lt;Font Size="Size in Pixels" Face="Font Name" Color="Named color" &gt;&lt;/Font&gt; Set Font size,color and font name.<br/>
        ...
        /// <summary>
        /// Gets or Sets the image list to use in the gutter margin.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or Sets the image list to use in the auto list.
        /// </summary>
        [Category("Appearance"), Description(
            "Gets or Sets the image list to use in the auto list.")
        ]
        ...
        /// <summary>
        /// Determines what indent style to use on a new line.
        /// </summary>
        [Category("Behavior")]
        [Description(
        ...
        /// <summary>
        /// Gets or Sets the SyntaxDocument the control is currently attached to.
        /// </summary>
        [Category("Content")]
        [Description(
        ...
        /// <summary>
        /// Get or Set whether or not tooltips will be displayed for collapsed blocks.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Gets or Sets if bracket matching is active
        ...
        /// <summary>
        /// Resumes painting and auto sizes the AutoList.
        /// </summary>		
        ...
        /// <summary>
        /// Clears the content in the auto list.
        /// </summary>
        ...
        /// <summary>
        /// Adds an item to the auto list control.
        /// </summary>
        /// <example>
        /// <code>
        /// MySyntaxBox.AutoListClear();
        ...
        /// </code>
        /// </example>
        /// <param name="text">The text to display in the auto list</param>
        ...
        /// <summary>
        /// Finds the next occurrence of the pattern in the find/replace dialog
        /// </summary>
...
#pragma warning restore CS0809 // Obsolete member overrides non-obsolete member
        ...
        */
        ...
        /// <summary>
        /// The currently highlighted text in the auto list.
        /// </summary>
        [Browsable(false)]
        ...
        //VVV - actions handlers ---------------
        private void Undo(object sender, KeyboardActionEventArgs args)
        {
            Undo();
        }

        private void Redo(object sender, KeyboardActionEventArgs args)
        {
            Redo();
        }

        private void FindNext(object sender, KeyboardActionEventArgs args)
        {
            FindNext();
        }

        private void Copy(object sender, KeyboardActionEventArgs args)
        {
            Copy();
        }

        private void CutClear(object sender, KeyboardActionEventArgs args)
        {
            CutClear();
        }

        private void Paste(object sender, KeyboardActionEventArgs args)
        {
            Paste();
        }

        private void Cut(object sender, KeyboardActionEventArgs args)
        {
            Cut();
        }

        private void SelectAll(object sender, KeyboardActionEventArgs args)
        {
            SelectAll();
        }

        private void ShowFind(object sender, KeyboardActionEventArgs args)
        {
            ShowFind();
        }

        private void ShowReplace(object sender, KeyboardActionEventArgs args)
        {
            ShowReplace();
        }

        private void ShowGotoLine(object sender, KeyboardActionEventArgs args)
        {
            ShowGotoLine();
        }

        private void ShowSettings(object sender, KeyboardActionEventArgs args)
        {
            ShowSettings();
        }

        private void ToggleBookmark(object sender, KeyboardActionEventArgs args)
        {
            ToggleBookmark();
        }

        private void GotoNextBookmark(object sender, KeyboardActionEventArgs args)
        {
            GotoNextBookmark();
        }

        private void GotoPreviousBookmark(object sender, KeyboardActionEventArgs args)
        {
            GotoPreviousBookmark();
        }

        private void ClearSelection(object sender, KeyboardActionEventArgs args)
        {
            ClearSelection();
        }
        //--VVV
        ...
        {
            InfoTipSelectedIndexChanged?.Invoke(null, null);
        }

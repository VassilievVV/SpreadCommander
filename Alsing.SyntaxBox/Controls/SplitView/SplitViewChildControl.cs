...
using Alsing.Windows.Forms.Controls.BaseControls;
using System;
using System.ComponentModel;
using System.Drawing;
using System.Windows.Forms;
using Alsing.Windows.Forms.Controls.ThumbControl;

//namespace Alsing.Windows.Forms.CoreLib
namespace Alsing.Windows.Forms.Controls.SplitView
{
    /// <summary>
    ...
    public class SplitViewChildControl : BaseControl
    {
        ...
        public ThumbControl.ThumbControl LeftThumb;
        public ThumbControl.ThumbControl TopThumb;

		//VVV
		//protected HScrollBar hScroll;
		//protected VScrollBar vScroll;
		protected Control hScroll;
		protected Control vScroll;

		protected IScrollBar HScroll
		{
			get {return (IScrollBar)hScroll;}
		}

		protected IScrollBar VScroll
		{
...
//			Alsing.Windows.NativeMethods.OpenThemeData (this.hScroll.Handle,"SCROLLBAR");
			...
			//VVV
			hScroll = (Control)CreateHScrollBar();
			vScroll = (Control)CreateVScrollBar();

			hScroll.Name = "hScroll";
			hScroll.Size = new System.Drawing.Size(440, 16);
			hScroll.TabIndex = 0;

			((IScrollBar)vScroll).Maximum = 300;
			((IScrollBar)vScroll).Minimum = 0;
		...
		//VVV - create custom horizontal scroll bar
		protected virtual IScrollBar CreateHScrollBar()
		{
			return new CustomHScrollBar();
		}

		//VVV - create custom vertical scroll bar
		protected virtual IScrollBar CreateVScrollBar()
		{
			return new CustomVScrollBar();
		}

		//VVV
		public Color FillerBackColor
		{
			get { return Filler.BackColor; }
			set { Filler.BackColor = value; }
		}
        ...
        /// <summary>
        /// Gets ot Sets if the Top thumb control is visible or not.
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.TopThumb = new Alsing.Windows.Forms.Controls.ThumbControl.ThumbControl();
            this.LeftThumb = new Alsing.Windows.Forms.Controls.ThumbControl.ThumbControl();
	...
	//VVV - define scrollbars interface
	...
	class CustomHScrollBar: System.Windows.Forms.HScrollBar, IScrollBar
	{
	}

	class CustomVScrollBar: System.Windows.Forms.VScrollBar, IScrollBar
	{
	}
}
...
namespace Alsing.Windows.Forms.Controls.SplitView
{
	...
	public class SplitViewControl : Control
	{
		...
		public SplitViewControl()
		{
			...
			//VVV
			Center.BackColor     = Color.DarkBlue;
			Vertical.BackColor   = Color.DarkBlue;
			Horizontal.BackColor = Color.DarkBlue;
		}
		...
		//VVV
		public Color SplitBackColor
		{
			get { return Vertical.BackColor; }
			set
			{
				Vertical.BackColor   = value;
				Horizontal.BackColor = value;
				Center.BackColor     = value;
			}
		}
        ...
        {
			HideLeft?.Invoke(this, new EventArgs());
		}

        private void OnHideTop()
        {
			HideTop?.Invoke(this, new EventArgs());
		}
